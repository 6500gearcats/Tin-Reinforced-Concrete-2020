// PROPOSAL:
// I think that stuff like this should be implemented directly in 
// robot code as it is really specific to robot systems and functions. 
// It is also just really complicated and takes a lot of processing 
// time when we don't need to use it. However, I like how the bindings
// work and I think that we can implement the bindings in maybe the 
// TRCController class to simplify things.
...
// import frc.team6500.trc.util.TRCTypes.ControllerType;
// import frc.team6500.trc.util.TRCTypes.VerbosityType;

// /**
//  * Handle input from the joysticks
//  */
